...
class MainPage : Component
{
    ...
    private VisualNode RenderPost(Post post)
    {
        return new Grid()
        {
            new Border()
            {
                new Grid()
                {
                    ...
                    new Grid()
                        ...
                        .Opacity(0.1),
                    new Grid("Auto, Auto, *", "72, Auto")
                    {
                        new Grid()
                        {
                            new Border()
                            {
                                new Image(post.User.Image)
                                    .HCenter()
                                    .VCenter()
                                    .Margin(1)
                        ...
                        new Grid("Auto, Auto", "*")
                        {
                            new Label(post.User.Name.ToUpper())
                                .Style("UserNameStyle"),
                            new Label("4 HOURS AGO")
                                .GridRow(1)
                        ...
                        new Grid("*", "Auto, *")
                        {
                            ...
                            new StackLayout
                            {
                                ...
                                new Label(post.User.From.ToUpper())
                                    .Style("FromTextStyle")
                            }
                            .GridColumn(1)
                        }
            ...
            .StrokeShape(new RoundRectangle().CornerRadius(12, 120, 12, 12))
